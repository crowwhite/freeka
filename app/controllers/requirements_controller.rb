class RequirementsController < ApplicationController
  ...
  private
    ...
    def requirement_params
      params.require(:requirement).permit(:title, :details, { category_ids: [] }, :expiration_date, :enabled, :info_file, address_attributes: [:id, :street, :city, :country_code, :state_code])
    end
